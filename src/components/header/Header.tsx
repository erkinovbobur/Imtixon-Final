      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        ...
        <nav className="bg-gray-200 py-2">
          <div className="container mx-auto flex space-x-4 justify-around">
            <Link to="/Lipstick" className="hover:text-red-500">Lipstick</Link>
            <Link to="/Foundation" className="hover:text-red-500">Foundation</Link>
            <Link to="/Eyeliner" className="hover:text-red-500">Eyeliner</Link>
            <Link to="/Mascara" className="hover:text-red-500">Mascara</Link>
            <Link to="/Blush" className="hover:text-red-500">Blush</Link>
            <Link to="/Bronzer" className="hover:text-red-500">Bronzer</Link>
