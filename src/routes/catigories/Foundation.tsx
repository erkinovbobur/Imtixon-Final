...
import { useFoundationQuery } from "../../redux/api/usersApi";
...
const Foundation = () => {
  const { data, isLoading, isError } = useFoundationQuery();
  ...
  if (isError) {
    return (
      <div className="flex justify-center items-center h-screen">
        <p className="text-red-500 text-xl">Foundation data fetching error. Please try again.</p>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center mb-8 text-white">Foundation Products</h1>
